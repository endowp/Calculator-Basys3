set_property SRC_FILE_INFO {cfile:{D:/Endo/year3-1/HW Sys Lab/project/project.srcs/constrs_1/new/Basys3 constraint.xdc} rfile:{../../../project.srcs/constrs_1/new/Basys3 constraint.xdc} id:1} [current_design]
